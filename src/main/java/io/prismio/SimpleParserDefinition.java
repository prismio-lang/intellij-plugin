...
import io.prismio.parser.PrismioParser;
...
final class SimpleParserDefinition implements ParserDefinition {
  ...
  public PsiElement createElement(ASTNode node) {
    // This parser produces a flat token stream plus FUNCTION_DECL/BLOCK composite nodes.
    // All composite and leaf nodes are wrapped generically via ASTWrapperPsiElement.
