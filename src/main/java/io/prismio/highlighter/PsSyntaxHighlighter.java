...
public class PsSyntaxHighlighter extends SyntaxHighlighterBase {
        ...
        // Keywords
        public static final TextAttributesKey KEYWORD = createTextAttributesKey("PRISMIO_KEYWORD",
                        DefaultLanguageHighlighterColors.KEYWORD);

        public static final TextAttributesKey TYPE_KEYWORD = createTextAttributesKey("PRISMIO_TYPE",
                        DefaultLanguageHighlighterColors.CLASS_NAME);

        // Literals
        public static final TextAttributesKey STRING = createTextAttributesKey("PRISMIO_STRING",
                        DefaultLanguageHighlighterColors.STRING);

        public static final TextAttributesKey NUMBER = createTextAttributesKey("PRISMIO_NUMBER",
                        DefaultLanguageHighlighterColors.NUMBER);

        public static final TextAttributesKey BOOLEAN = createTextAttributesKey("PRISMIO_BOOLEAN",
                        DefaultLanguageHighlighterColors.KEYWORD);

        public static final TextAttributesKey CHARACTER = createTextAttributesKey("PRISMIO_CHAR",
                        DefaultLanguageHighlighterColors.STRING);

        // Operators and separators
        public static final TextAttributesKey OPERATOR = createTextAttributesKey("PRISMIO_OPERATOR",
                        DefaultLanguageHighlighterColors.OPERATION_SIGN);

        public static final TextAttributesKey SEPARATOR = createTextAttributesKey("PRISMIO_SEPARATOR",
                        DefaultLanguageHighlighterColors.BRACES);

        public static final TextAttributesKey COMMA = createTextAttributesKey("PRISMIO_COMMA",
                        DefaultLanguageHighlighterColors.COMMA);

        public static final TextAttributesKey SEMICOLON = createTextAttributesKey("PRISMIO_SEMICOLON",
                        DefaultLanguageHighlighterColors.SEMICOLON);

        public static final TextAttributesKey DOT = createTextAttributesKey("PRISMIO_DOT",
                        DefaultLanguageHighlighterColors.DOT);

        // Comments
        public static final TextAttributesKey LINE_COMMENT = createTextAttributesKey("PRISMIO_LINE_COMMENT",
                        DefaultLanguageHighlighterColors.LINE_COMMENT);

        public static final TextAttributesKey BLOCK_COMMENT = createTextAttributesKey("PRISMIO_BLOCK_COMMENT",
                        DefaultLanguageHighlighterColors.BLOCK_COMMENT);

        // Identifiers
        public static final TextAttributesKey IDENTIFIER = createTextAttributesKey("PRISMIO_IDENTIFIER",
                        DefaultLanguageHighlighterColors.IDENTIFIER);

        public static final TextAttributesKey FUNCTION_DECLARATION = createTextAttributesKey("PRISMIO_FUNCTION_DECL",
                        DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);

        public static final TextAttributesKey FUNCTION_CALL = createTextAttributesKey("PRISMIO_FUNCTION_CALL",
                        DefaultLanguageHighlighterColors.FUNCTION_CALL);

        public static final TextAttributesKey PARAMETER = createTextAttributesKey("PRISMIO_PARAMETER",
                        DefaultLanguageHighlighterColors.PARAMETER);

        public static final TextAttributesKey STRUCT_NAME = createTextAttributesKey("PRISMIO_STRUCT",
                        DefaultLanguageHighlighterColors.CLASS_NAME);

        public static final TextAttributesKey ENUM_NAME = createTextAttributesKey("PRISMIO_ENUM",
                        DefaultLanguageHighlighterColors.CLASS_NAME);

        // Special
        public static final TextAttributesKey BAD_CHARACTER = createTextAttributesKey("PRISMIO_BAD_CHARACTER",
